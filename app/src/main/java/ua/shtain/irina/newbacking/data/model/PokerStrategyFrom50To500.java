...
public class PokerStrategyFrom50To500 extends BaseModel {
    @PrimaryKey
    @Column
    ...
    public PokerStrategyFrom50To500(String title, String link, String user) {
        this.title = title;
        this.link = link;
        this.user = user;
    }

    public PokerStrategyFrom50To500() {
    }
